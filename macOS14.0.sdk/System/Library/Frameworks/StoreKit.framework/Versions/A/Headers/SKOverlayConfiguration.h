...
} API_AVAILABLE(ios(14.0), xros(1.0)) API_UNAVAILABLE(macos, watchos) __TVOS_PROHIBITED NS_SWIFT_NAME(SKOverlay.Position);

SK_EXTERN_CLASS
API_AVAILABLE(ios(14.0), xros(1.0)) API_UNAVAILABLE(macos, watchos) __TVOS_PROHIBITED
...
@property (nonatomic, retain, nullable) NSString *customProductPageIdentifier API_AVAILABLE(ios(15.0), xros(1.0)) API_UNAVAILABLE(macos, watchos) __TVOS_PROHIBITED;

/// An optional extra parameter for specifying the version of your app that will be shown to the user.
@property (nonatomic, retain, nullable) NSString *latestReleaseID API_AVAILABLE(ios(15.0), xros(1.0)) API_UNAVAILABLE(macos, watchos) __TVOS_PROHIBITED;
...
- (void)setAdImpression:(SKAdImpression *)impression API_AVAILABLE(ios(16.0)) API_UNAVAILABLE(macos, watchos, xros) __TVOS_PROHIBITED;
