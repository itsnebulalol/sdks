...
typedef NSString * SKAdNetworkCoarseConversionValue NS_TYPED_ENUM NS_SWIFT_NAME(SKAdNetwork.CoarseConversionValue) API_AVAILABLE(ios(16.0)) API_UNAVAILABLE(macos,watchos,xros) __TVOS_PROHIBITED;

SK_EXTERN SKAdNetworkCoarseConversionValue const SKAdNetworkCoarseConversionValueHigh  API_AVAILABLE(ios(16.0)) API_UNAVAILABLE(macos,watchos,xros) __TVOS_PROHIBITED;
SK_EXTERN SKAdNetworkCoarseConversionValue const SKAdNetworkCoarseConversionValueMedium  API_AVAILABLE(ios(16.0)) API_UNAVAILABLE(macos,watchos,xros) __TVOS_PROHIBITED;
SK_EXTERN SKAdNetworkCoarseConversionValue const SKAdNetworkCoarseConversionValueLow  API_AVAILABLE(ios(16.0)) API_UNAVAILABLE(macos,watchos,xros) __TVOS_PROHIBITED;
...
SK_EXTERN NSString * const SKStoreProductParameterAdNetworkSourceIdentifier API_AVAILABLE(ios(16.0)) API_UNAVAILABLE(macos, watchos, xros);
