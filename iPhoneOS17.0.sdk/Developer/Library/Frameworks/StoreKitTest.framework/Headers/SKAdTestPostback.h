...
typedef NSString * SKAdTestPostbackVersion NS_TYPED_ENUM API_AVAILABLE(ios(15.4)) API_UNAVAILABLE(macos,watchos,tvos,xros);

SK_EXTERN SKAdTestPostbackVersion const SKAdTestPostbackVersion2_1 API_AVAILABLE(ios(15.4)) API_UNAVAILABLE(macos,watchos,tvos,xros);
SK_EXTERN SKAdTestPostbackVersion const SKAdTestPostbackVersion2_2 API_AVAILABLE(ios(15.4)) API_UNAVAILABLE(macos,watchos,tvos,xros);
SK_EXTERN SKAdTestPostbackVersion const SKAdTestPostbackVersion3_0 API_AVAILABLE(ios(15.4)) API_UNAVAILABLE(macos,watchos,tvos,xros);
SK_EXTERN SKAdTestPostbackVersion const SKAdTestPostbackVersion4_0 API_AVAILABLE(ios(16.4)) API_UNAVAILABLE(macos,watchos,tvos,xros);

SK_EXTERN_CLASS API_AVAILABLE(ios(15.4)) API_UNAVAILABLE(macos,watchos,tvos,xros) @interface SKAdTestPostback : NSObject
            ...
            sourceAppStoreItemIdentifier:(NSInteger)sourceAppStoreItemIdentifier
                         conversionValue:(NSInteger)conversionValue
                            ...
                            isRedownload:(BOOL)isRedownload
                                  didWin:(BOOL)didWin
                             postbackURL:(NSString *)postbackURL API_AVAILABLE(ios(15.4)) API_UNAVAILABLE(macos,watchos,tvos,xros);
...
- (nullable instancetype)initWithVersion:(SKAdTestPostbackVersion)version
            ...
            sourceAppStoreItemIdentifier:(NSInteger)sourceAppStoreItemIdentifier
                            ...
                            isRedownload:(BOOL)isRedownload
                                  didWin:(BOOL)didWin
                             postbackURL:(NSString *)postbackURL API_AVAILABLE(ios(16.4)) API_UNAVAILABLE(macos,watchos,tvos,xros);
...
@property (nonatomic, strong, readonly, nullable) NSString *sourceIdentifier API_AVAILABLE(ios(16.4)) API_UNAVAILABLE(macos,watchos,tvos,xros);
...
@property (nonatomic, strong, readonly, nullable) NSString *sourceDomain API_AVAILABLE(ios(16.4)) API_UNAVAILABLE(macos,watchos,tvos,xros);
...
@property (nonatomic, assign, readonly) NSInteger fineConversionValue API_AVAILABLE(ios(16.4)) API_UNAVAILABLE(macos,watchos,tvos,xros);

/// The coarse conversion value for this postback.
@property (nonatomic, strong, readonly, nullable) SKAdNetworkCoarseConversionValue coarseConversionValue API_AVAILABLE(ios(16.4)) API_UNAVAILABLE(macos,watchos,tvos,xros);
...
@property (nonatomic, assign, readonly) NSInteger postbackSequenceIndex API_AVAILABLE(ios(16.4)) API_UNAVAILABLE(macos,watchos,tvos,xros);
...
SK_EXTERN_CLASS API_AVAILABLE(ios(15.4)) API_UNAVAILABLE(macos,watchos,tvos,xros) __TVOS_PROHIBITED @interface SKAdTestPostbackResponse : NSObject
