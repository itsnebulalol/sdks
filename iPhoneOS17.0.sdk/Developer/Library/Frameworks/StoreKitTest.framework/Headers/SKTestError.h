...
SK_EXTERN NSErrorDomain const SKTestErrorDomain API_AVAILABLE(ios(14.0), macos(11.0), tvos(14.0), watchos(7.0), xros(1.0));
...
} API_AVAILABLE(ios(14.0), macos(11.0), tvos(14.0), watchos(7.0), xros(1.0));
...
} API_AVAILABLE(ios(15.4)) API_UNAVAILABLE(macos,watchos,xros) __TVOS_PROHIBITED;
